...
{
    private const string KerbinJson = """{"Name":"Kerbin","Mass":5.2915158E+22,"Radius":600000.0,"AtmosphereHeight":70000.0,"SoiRadius":84159286.0,"Parent":"Sun","OrbitalPeriod":9203544.6,"SemiMajorAxis":13599840256.0,"RotationPeriodS":21549.4}""";
    private const string MunJson    = """{"Name":"Mun","Mass":9.7599066E+20,"Radius":200000.0,"AtmosphereHeight":0.0,"SoiRadius":2429559.0,"Parent":"Kerbin","OrbitalPeriod":138984.38,"SemiMajorAxis":12000000.0,"RotationPeriodS":138984.38}""";
    private const string SunJson    = """{"Name":"Sun","Mass":1.7565670E+28,"Radius":261600000.0,"AtmosphereHeight":600000.0,"SoiRadius":6E+13,"Parent":null,"OrbitalPeriod":null,"SemiMajorAxis":null,"RotationPeriodS":432000.0}""";
    ...
    [Fact]
    public async Task GetBodyInfoAsync_MapsRotationPeriodCorrectly()
    {
        var mock = new Mock<IKrpcConnection>();
        mock.Setup(c => c.GetBodyInfo(null)).Returns($"[{KerbinJson}]");
