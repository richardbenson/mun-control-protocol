...
// TechTreeService (the single [KRPCService(Name="MunControlProtocol")] class).
public static class PartsService
{
    ...
    internal static void RefreshCache()
    {
        ...
        {
            Debug.LogError("[MunControlProtocol] Failed to refresh parts cache: " + ex);
        }
    }
    ...
    private static string BuildJson()
    {
        ...
        foreach (var part in PartLoader.LoadedPartsList)
        {
            ...
            if (part.partPrefab != null)
            {
                ...
                catch (Exception ex) { Debug.LogWarning("[MunControlProtocol] Module info failed for " + part.name + ": " + ex.Message); }
            }
